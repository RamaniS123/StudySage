...
import { Fragment, useRef, useState, useTransition, useContext } from "react";
        ...
        >
          ...
          >
            <Textarea
              ...
              className="placeholder:tet-muted-foreground resize-none rounded-none border-none bg-transparent p-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0"
              style={{
                minHeight: "0",
                lineHeight: "normal",
              }}
